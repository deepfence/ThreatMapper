...
helm show readme deepfence/deepfence-agent --version 1.4.9
helm show values deepfence/deepfence-agent --version 1.4.9

helm install deepfence-agent deepfence/deepfence-agent \
    --set managementConsoleUrl=x.x.x.x \
    --set deepfenceKey=73f6f3d0-9931-4b31-8967-fd6adf475f80 \
    --set image.tag=1.4.3 \
    --set image.clusterAgentImageTag=1.4.3 \
...
helm show values deepfence/deepfence-agent --version 1.4.9 > deepfence_agent_values.yaml

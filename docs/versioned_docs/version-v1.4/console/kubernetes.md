...
3. **Install the ThreatMapper Console**
    ...
    helm show readme deepfence/deepfence-console --version 1.4.9
    helm show values deepfence/deepfence-console --version 1.4.9

    helm install deepfence-console deepfence/deepfence-console --version 1.4.9
    ```
    ...
    ```bash
    helm install deepfence-console deepfence/deepfence-console --set image.tag=1.4.3 --version 1.4.9
    ```
    :::
...
4. **Enable external access** with the ```deepfence-router``` helm chart:
    ...
    ```bash
    helm show readme deepfence/deepfence-router --version 1.4.9
    helm show values deepfence/deepfence-router --version 1.4.9

    helm install deepfence-router deepfence/deepfence-router --version 1.4.9
    ```

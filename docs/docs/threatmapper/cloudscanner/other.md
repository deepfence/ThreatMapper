...
Scanning is done directly, using a local [Sensor Agent](/docs/threatmapper/sensors) rather than by using the Cloud Scanner task employed by the cloud platform integrations.

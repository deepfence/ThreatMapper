...
NOTIFICATION_TYPE_SECRET_SCAN = "secret"
NOTIFICATION_TYPES = [NOTIFICATION_TYPE_VULNERABILITY, NOTIFICATION_TYPE_USER_ACTIVITY, NOTIFICATION_TYPE_SECRET_SCAN]
...
SECRET_SCAN_TYPE = SECRET_SCAN_INDEX

...
const ACTION_TYPES = [
  ...
  'PDF_REPORT_GENERATE_REQUEST',
  'PDF_REPORT_GENERATE_SUCCESS',
  'PDF_REPORT_GENERATE_FAILURE',
  'GET_PDF_REPORT_STATUS_REQUEST',
  'GET_PDF_REPORT_STATUS_SUCCESS',
  'GET_PDF_REPORT_STATUS_FAILURE',

...
const ScheduledJobs = props => {
  useEffect(() => {
    getScheduledJobs();
  }, []);

  const updateTasks = params => {
    const { updateScheduledTasksAction: action } = props;
    return action(params);
  };

  const getScheduledJobs = () => {
    const { getScheduledTasksAction: action } = props;
    return action();
  };
        ...
        <DfTableV2
          ...
          columns={[
            ...
            },
            {
              ...
              accessor: 'is_enabled',
              Cell: cell => (
                <div>{cell.value === true ? 'Active' : 'Inactive'}</div>
              ),
              width: 80,
            },
            {
            ...
            actions: [
              {
                ...
                postClickSuccess: () => getScheduledJobs(),
                showConfirmationDialog: true,
                confirmationDialogParams: {
                  dialogTitle: 'Disabled these records?',
                  dialogBody:
                    'Are you sure you want to disable the selected records?',
              ...
              },
              {
                ...
                confirmationDialogParams: {
                  ...
                  dialogBody:
                    'Are you sure you want to enable the selected records?',

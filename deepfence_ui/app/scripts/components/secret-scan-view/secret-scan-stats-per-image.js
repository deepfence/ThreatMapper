...
const SecretScanStatsPerImage = props => {
  ...
  // actionType from parent will be one of these action: mask-action, unmask-action, delete-action (generated by table row action)
  // any changes of these value should update count chart
  const { actionType } = props;

  useEffect(() => {
    const { startPolling } = props;
    if (actionType !== '') {
      startPolling();
    }
  }, [actionType]);

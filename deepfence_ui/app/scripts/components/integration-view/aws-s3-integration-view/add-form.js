...
const AWSS3IntegrationForm = props => {
  ...
  const { bucketName, s3FolderPath, awsAccessKey, awsSecretKey, awsRegion } =
    state;
        ...
        <div className="col-md-4">
          <div
            className={`form-group ${
              submitted && !bucketName ? 'has-error' : ''
            }`}
          >
            ...
            {submitted && !bucketName && (
              <div className="field-error">S3 Bucket Name is required</div>
            )}
          </div>
        </div>
        <div className="col-md-4">
          <div
            className={`form-group ${
              submitted && !s3FolderPath ? 'has-error' : ''
            }`}
          >
            ...
            {submitted && !s3FolderPath && (
              <div className="field-error">S3 folder is required</div>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="col-md-4">
          ...
          >
            ...
            {submitted && !awsAccessKey && (
              <div className="field-error">AWS Access Key is required</div>
            )}
          </div>
        </div>
        <div className="col-md-4">
          ...
          >
            ...
            {submitted && !awsSecretKey && (
              <div className="field-error">AWS Secret Key is required</div>
            )}
          </div>
        </div>
      </div>

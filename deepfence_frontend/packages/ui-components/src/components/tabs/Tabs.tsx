      ...
      true: [
        dfTwMerge(
          cx(
            ...
            // selected
            'dark:data-[state=active]:shadow-[0_-3px_0_#3185FF_inset] transition-shadow duration-[0.2s] ease-[ease-in]',
            // hover
            'dark:hover:shadow-[0_-3px_0_#3185FF_inset] transition-shadow duration-[0.2s] ease-[ease-in]',

...
type ActionFunctionType =
  | ReturnType<typeof getVulnerabilityApiClient>['deleteVulnerabilities']
  | ReturnType<typeof getVulnerabilityApiClient>['maskVulnerabilities']
  | ReturnType<typeof getVulnerabilityApiClient>['notifyVulnerabilities']
  | ReturnType<typeof getVulnerabilityApiClient>['unMaskVulnerabilities'];
...
const action = async ({
  ...
  if (actionType === ActionEnumType.DELETE) {
    apiFunction = getVulnerabilityApiClient().deleteVulnerabilities;
  } else if (actionType === ActionEnumType.MASK) {
    apiFunction = getVulnerabilityApiClient().maskVulnerabilities;
  } else if (actionType === ActionEnumType.UNMASK) {
    apiFunction = getVulnerabilityApiClient().unMaskVulnerabilities;
  } else if (actionType === ActionEnumType.NOTIFY) {
    apiFunction = getVulnerabilityApiClient().notifyVulnerabilities;
  }

...
const toolbar = new G6.ToolBar({
  ...
  getContent: () => `<div>
    <ul class="list-none m-0 p-2.5 pt-0 rounded-md drop-shadow-md shadow-gray-500 border-solid border border-gray-200 dark:border-gray-700">
...
const DEFAULT_OPTIONS: G6GraphOptionsWithoutContainer = {
  animate: false,
  fitCenter: true,
  groupByTypes: false,
  defaultNode: {

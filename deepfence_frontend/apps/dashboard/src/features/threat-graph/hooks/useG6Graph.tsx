...
export const toolbar = new G6.ToolBar({
  ...
  getContent: () => `<div>
    <ul class="list-none m-0 p-1 pt-0 rounded-md border dark:border-bg-grid-border bg-gray-50 dark:bg-bg-breadcrumb-bar">
      <li code="zoom-out" title="Zoom Out" class="mt-1 cursor-pointer">
        <svg class="fill-gray-500 dark:fill-df-gray-400" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
      ...
      <li code="zoom-in" title="Zoom In" class="mt-1 cursor-pointer">
        <svg class="fill-gray-500 dark:fill-df-gray-400" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
          <path d="M639.936 416a32 32 0 0 1-32 32h-256a32 32 0 0 1 0-64h256a32 32 0 0 1 32 32z m289.28 503.552a41.792 41.792 0 0 1-58.752-6.656l-182.656-213.248A349.76 349.76 0 0 1 480 768 352 352 0 1 1 832 416a350.4 350.4 0 0 1-83.84 227.712l185.664 216.768a41.856 41.856 0 0 1-4.608 59.072zM479.936 704c158.784 0 288-129.216 288-288S638.72 128 479.936 128a288.32 288.32 0 0 0-288 288c0 158.784 129.216 288 288 288z" p-id="3853"></path>
        </svg>
      </li>
      <li code="actual-size" title="Re-center" class="mt-1 cursor-pointer flex items-center justify-center">
        <svg class="fill-gray-500 dark:fill-df-gray-400" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14" height="14">

...
const PostureCloudScanResults = () => {
  ...
  const groupedByControles = searchParams.get('groupByControls') !== 'false';
  ...
  return (
    <>
      ...
      <div className="mx-4">
        ...
        {groupedByControles ? <CloudPostureResultsGrouped /> : <CloudPostureResults />}
        <Outlet />
      </div>
    </>
  );

...
const ColorClasses: Record<keyof DashboardLoaderData['nodeCounts'], string> = {
  ...
  kubernetes_cluster: 'text-pink-500 dark:text-pink-300',
    ...
    <div className="py-2 basis-full flex flex-col h-full cursor-pointer hover:bg-gray-50 hover:dark:bg-gray-700/20 pl-2 justify-center">
      ...
      >
        <div className="font-light flex text-gray-700 dark:text-white items-center">
          <div className={cx('w-8 h-8 p-1 cursor-pointer', ColorClasses[type])}>
            <Icon />
          </div>
          <span className="pl-1 text-2xl">{count}</span>
        </div>
    ...
    <div className="py-2 basis-full flex flex-col h-full cursor-pointer hover:bg-gray-50 hover:dark:bg-gray-700/20 pl-2 justify-center">
      <div className={cx('pr-4')}>
        <div className="font-light flex text-gray-700 dark:text-white items-center">
          <div
            className={cx(
              'w-7 h-7 m-1 cursor-pointer bg-gray-200 dark:bg-gray-600 animate-pulse rounded-full',
            )}
          />
          <span className="pl-1 h-6 my-1 w-6 bg-gray-200 dark:bg-gray-600 animate-pulse" />
        </div>

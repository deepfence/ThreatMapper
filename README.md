...
docker run -dit \
    ...
    -e https_proxy="" \
    -e no_proxy="" \
    quay.io/deepfenceio/deepfence_agent_ce:2.5.5
```

Note: Image tag `quay.io/deepfenceio/deepfence_agent_ce:2.5.5-multiarch` is supported in amd64 and arm64/v8 architectures.

...
var (
	ErrorMessage = map[string]string{
		...
		"Config.Username":       "invalid username",
		"Config.Password":       "invalid password",
		"Config.JiraProjectKey": "invalid jira project key",
		"Config.JiraAssignee":   "invalid jira assignee",
		"Config.IssueType":      "invalid issue type",
		"Config.IsAuthToken":    "invalid is auth token",
		"Config.APIToken":       "invalid api token",
		"Config.ServiceKey":     "invalid service key",
		...
		"Config.Channel":        "invalid channel",

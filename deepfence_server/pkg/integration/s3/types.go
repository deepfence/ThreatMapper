...
type Config struct {
	...
	AWSAccessKey         string `json:"aws_access_key" validate:"min=16,max=128" required:"true"`
	AWSSecretKey         string `json:"aws_secret_key" validate:"min=16,max=128" required:"true"`
	...
	UseIAMRole           bool   `json:"use_iam_role" validate:"required"`

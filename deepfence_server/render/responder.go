...
func DefaultResponder(w http.ResponseWriter, r *http.Request, statusCode int, v interface{}) {
	if v != nil {
	...
	case ContentTypeJSON:
		JSON(w, r, statusCode, v)
	case ContentTypeXML:
		XML(w, r, statusCode, v)
	default:
		JSON(w, r, statusCode, v)
	}
}
...
func XML(w http.ResponseWriter, r *http.Request, statusCode int, v interface{}) {
	b, err := xml.Marshal(v)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return

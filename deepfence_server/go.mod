...
require (
	...
	github.com/typetypetype/conntrack v1.0.1-0.20181112022515-9d9dd841d4eb // indirect
	...
	github.com/weaveworks/tcptracer-bpf v0.0.0-20200114145059-84a08fc667c0 // indirect

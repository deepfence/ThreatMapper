...
func TestRendererForTopologyWithFiltering(t *testing.T) {
	...
	input.Container.Nodes[fixture.ClientContainerNodeID] = input.Container.Nodes[fixture.ClientContainerNodeID].WithLatests(map[string]string{
		docker.LabelPrefix + "deepfence.role": "system",
	})
...
func getTestContainerLabelFilterTopologySummary(t *testing.T, exclude bool) (detailed.NodeSummaries, error) {
	...
	return detailed.Summaries(ctx, detailed.RenderContext{Report: fixture.Report}, render.Render(ctx, fixture.Report, renderer, filter).Nodes, false), nil
}
...
func TestAPITopologyAddsKubernetes(t *testing.T) {
	...
	checkRequest(t, ts, "POST", "/topology-api/report", buf.Bytes())

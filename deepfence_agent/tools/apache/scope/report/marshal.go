...
// variable msgpack = 0 means json, msgpack = 1 means use msgpack code, msgpack = 2 means use binc codec
func MakeFromBinary(ctx context.Context, r io.Reader, gzipped bool, msgpack int) (*Report, error) {

...
replace github.com/deepfence/kubernetes-scanner => github.com/deepfence/kubernetes-scanner v0.0.0-20230228135439-cdd38c3c9381
...
require (
	...
	github.com/deepfence/compliance v0.1.3-0.20230315031021-8bd675373f9e // indirect

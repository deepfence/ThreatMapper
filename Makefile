...
default: certs init-container vulnerability-mapper elasticsearch redis postgres router api ui fetcher diagnosis agent secretscanner malwarescanner packagescanner

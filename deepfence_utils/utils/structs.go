...
type ReportOptions struct {
	...
	SBOMFormat string `json:"sbom_format" validate:"omitempty,oneof=syft-json@11.0.1 cyclonedx-json@1.5 spdx-json@2.3" enum:"syft-json@11.0.1,cyclonedx-json@1.5,spdx-json@2.3"`
}

...
func (u *updater) getUpdateInfo() (UpdateInfo, error) {
	...
	if updateInfoResponse == nil {
		log.WithField("package", u.Name).Info("No vulnerabilities obtained")
		return UpdateInfo{}, commonerr.ErrNotFound
	}
